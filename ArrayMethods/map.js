...
const years =  presidents.filter(pres=> pres.year>=1900 && pres.year<2000);

console.log(years)

let outcome =[
 {appid: 4000, 'name': "Garry's Mod", playtime_forever: 9314, img_icon_url: "4a6f25cfa2426445d0d9d6e233408de4d371ce8b", img_logo_url: "4d8ece61d4cee48cfb763a410f45263a24d63cf3"},
 {appid: 34900, 'name': "Bad Rats", playtime_forever: 0, img_icon_url: "8b159808cdec5d1532f3af8c22c16d72556e61b5", img_logo_url: "95229dc8b1ad50589429b930c9a09150e24c558d"},
 {appid: 550, 'name': "Left 4 Dead 2", playtime_forever: 162, img_icon_url: "7d5a243f9500d2f8467312822f8af2a2928777ed", img_logo_url: "205863cc21e751a576d6fff851984b3170684142"},
]
const outcome3 = outcome.map(madeup => madeup.appid)
console.log(outcome3)

const outcome4 =  outcome.filter(pres=> pres.year>=1900 && pres.year<2000);