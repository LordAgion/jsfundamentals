//Challenge: write a function that uses the Array.prototype.forEach() & the Array.prototype.push() methods within it. Before writing your function, 
//declare a variable of 'copy' that is initialized as an empty array. Using the forEach method, loop over all of the presidents from our presidents array. 
//Then, push the president's last name and the year they were born to our copy array as individual objects containing key/value pairs of each presidents respective 
//last name and date of birth. Then console.log our copy array.
const presidents = [
...
//     copy.push(element.last, element.year)
//   });
// console.log(copy);
...
// console.log(copy2);
//Challenge: using Array.prototype.sort(), sort the presidents by birth year, oldest to youngest. 
//You will need to implement logic that checks the year each president was born.


presidents.sort((a, b) => (a.year> b.year)?1: -1);
